        ...
        <div className="px-4 md:px-6 py-22 md:py-25 w-full max-w-7xl m-auto">
            ...
            <div className="grid md:grid-cols-3 gap-5 my-10">
                {structureData.map((item, index) => (
                    <div className="border text-[color:var(--muted)] border-[color:var(--border)] bg-[color:var(--surface-2)] p-10 ">
            ...
            <div className="w-full bg-[color:var(--surface-2)] border border-[color:var(--border)] my-10 rounded-lg p-8">
                <h4 className='text-[color:var(--text)] font-bold md:text-xl mb-4'>Note on Hosting</h4>
                <p className='text-[color:var(--muted)] md:text-lg'>I don't provide hosting directly, keeping services focused and asset-light. However, I offer full assistance with third-party hosting setup, domain procurement, and deployment to ensure a smooth launch.</p>
            </div>
